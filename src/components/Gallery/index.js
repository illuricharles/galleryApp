...
class Gallery extends Component {
  ...
  onClickThumbnail = imageList => this.setState({currentImageList: imageList})

  render() {
    const {currentImageList} = this.state
    const {imageUrl, imageAltText} = currentImageList
    return (
      <div className="bg-container">
        ...
        <ul className="thumbnail-section">
